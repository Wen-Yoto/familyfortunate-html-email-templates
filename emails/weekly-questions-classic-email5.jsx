    ...
    <Html lang="en">
      ...
      <body style={base}>
        <Section style={container}>
          ...
          <Text style={text.base}>
            <br />
            Has this week’s prompt inspired you? If not, remember you have 100 questions to choose
            from. Simply go to your membership page &&nbsp;
            <Link href="#" style={link}>
              select another question[link]
            </Link>
            &nbsp;.
            <br />
          </Text>
          ...
          <Text style={text.base}>
            As you&apos;re writing your story, it will automatically be saved to your private Family
            Fortunate account, so you don&apos;t have to worry about losing your work.
          </Text>
          ...
          <div
            style={{
              ...
              background: 'url(/static/Emailbottombannergetpublished2.png)',
              backgroundSize: 'cover',
              position: 'flex',
              width: '700px',
              height: '249px',
