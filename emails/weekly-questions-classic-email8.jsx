      ...
      <body style={base}>
        <Section style={container}>
          ...
          <div className="container">
            <Text style={text.base}>
              Would you like a wider variety of questions in your weekly emails? You can upgrade now
              to access our bank of over 500 questions & receive other great inclusions including
              being able to write your own questions. See all the Premium inclusions and receive a
              discount on your upgrade to the Premium package
            </Text>
          </div>
          ...
          <div
            style={{
              ...
              background: 'url(/static/upgrade1.png)',
              backgroundSize: 'cover',
              position: 'flex',
              width: '700px',
              height: '249px',
