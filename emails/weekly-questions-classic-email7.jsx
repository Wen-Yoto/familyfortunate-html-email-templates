      ...
      <body style={base}>
        <Section style={container}>
          ...
          <Text style={text.base}>
            ...
            it&apos;s the perfect gift so if someone you know has a special occasion coming up, you
            can buy them a Family Fortunate membership & receive a huge 25% member&apos;s discount.
            <br />
            <br />
          ...
          <div
            style={{
              ...
              background: 'url(/static/50percentoff.png)',
              backgroundSize: 'cover',
              position: 'flex',
              width: '428px',
              height: '305px',
