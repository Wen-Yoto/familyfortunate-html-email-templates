    ...
    <Html lang="en">
      ...
      <body style={base}>
        <Section style={container}>
          ...
          <Text style={text.heading}>Jonah, have you answered your first question?</Text>
          ...
          <Text style={text.subbaseitalic}>Welcome to Family Fortunate, and enjoy!</Text>

          <Text style={text.base}>
            <span style={{ fontWeight: 700 }}>Rachel</span>
            <br />
